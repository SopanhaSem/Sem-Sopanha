  ...
  return (
    <section className="py-16 ">
      <div className="container mx-auto px-4">
        ...
        <div
          className="grid grid-cols-1 mt-5 md:grid-cols-2 lg:grid-cols-3 gap-8"
          data-aos="fade-up"
        >
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <img
              src="https://lh3.googleusercontent.com/p/AF1QipN4PxveGztzradyBXeHV5E6NBHBLOS41pty7xfQ=s1360-w1360-h1020"
              alt="University"
              className="w-full h-40 object-cover"
            />
            <div className="p-6">
              ...
              <p className="text-gray-800">Expected Graduation: Graduated</p>
              <p className="text-gray-600 mt-4">
                Studied core subjects including Java OOP, HTML CSS JS, and web
                development.
              </p>
            </div>
          </div>
